...
const expected = {
  ...
  plq110_drm_modes: "6.6.118-android15-8-g93e223c276e7-abogki500782043-4k",
...
const expectedImports = {
  ...
  // Ace6 does not export copy_from_kernel_nofault, ksize, strchr,
  // drm_mode_destroy or drm_kms_helper_connector_hotplug_event, so the PLQ110
  // source no longer references them.
  plq110_drm_modes: ["__kmalloc", "__list_add_valid_or_report", "__list_del_entry_valid_or_report", "__stack_chk_fail", "_printk", "drm_kms_helper_hotplug_event", "drm_mode_duplicate", "drm_mode_probed_add", "drm_mode_vrefresh", "fortify_panic", "get_main_display", "kfree", "kmalloc_large", "kmemdup", "kmemdup_nul", "kstrtouint", "kstrtoull", "memcpy", "memset", "mutex_lock", "mutex_unlock", "of_find_node_by_name", "of_get_property", "param_ops_bool", "param_ops_string", "param_ops_uint", "param_ops_ullong", "scnprintf", "strncmp", "strnlen", "strsep"],
