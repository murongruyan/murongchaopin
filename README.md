...
## 功能特性
- **多档位刷新率支持**：真我 GT8 Pro 可枚举 123Hz、150-180Hz 档位；当前 RMX5200 样机实测 170Hz 稳定，175Hz 仍有少量细线，180Hz 花屏不可用。1+15 支持 123Hz、170-199Hz；DTBO 生成的新增节点会带同面板原厂 60Hz ADFR 命令组和 1Hz 映射，但尚无 1+15 真机验证。一加 Ace 6（PLQ110）自 v2.9.25 起提供与 1+15 相同的 170-199Hz DRM-KO 挡位（6.6 GKI 内核，尚无真机验证）。
...
- **兼容性**：本模块目前适配 **真我 GT8 Pro**、**OnePlus 12**、**OnePlus 15** 和 **OnePlus Ace 6（PLQ110）**。其他 OnePlus/Realme 机型请谨慎测试。
